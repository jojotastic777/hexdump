...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexdump.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexdump-common-common-refmap.json
        // fixed:   hexdump-common.refmap.json
