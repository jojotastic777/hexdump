...
abstract class HexdumpModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexdumpModDependenciesExtension>("hexdumpModDependencies")
