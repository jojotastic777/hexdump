...
Python web book docgen and [hexdoc](https://pypi.org/project/hexdoc) plugin for Hexdump.
...
```sh
GITHUB_REPOSITORY=jojotastic777/hexdump
GITHUB_SHA=main
GITHUB_PAGES_URL=https://github.com/jojotastic777/hexdump
```
